...
public class AutofitTextViewWithFont extends android.widget.TextView implements
		AutofitHelper.OnTextSizeChangeListener {
	private AutofitHelper mHelper;

	public AutofitTextViewWithFont(android.content.Context context) {
		super(context);
		init(context, null, 0);
	}

	public AutofitTextViewWithFont(android.content.Context context, android.util.AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs, 0);
	}

	public AutofitTextViewWithFont(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
	...
	private void init(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
		...
		if (!com.goteborgstad.custom.Global.appFontName.equalsIgnoreCase("")) {
			android.graphics.Typeface font = android.graphics.Typeface.createFromAsset(context.getAssets(), com.goteborgstad.custom.Global.appFontName);
			setTypeface(font);
		}
	}
	...
	public void setMinTextSize(int minSize) {
		mHelper.setMinTextSize(android.util.TypedValue.COMPLEX_UNIT_SP, minSize);
	}
